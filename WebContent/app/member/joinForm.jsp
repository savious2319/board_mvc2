      ...
      <form name="joinForm" action="${pageContext.request.contextPath}/member/MemberJoinOk.me" method="post">
         <center>
            <table  border="1" cellpadding="0" cellspacing="0" width="25%">
               ...
               <tr height="40px">
                  <td align="center" width="100px">아이디<!-- <input type="button" name="check" value="중복확인" onclick="checkId(joinForm.member_id.value)"> --></td>
...
<!--  최상위 경로를 미리 var contextPath에 넣는 작업을 했다 -->
